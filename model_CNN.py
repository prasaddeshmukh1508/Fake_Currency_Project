...
path1 = 'E:/Kirti Work/Fake Currency Detection/Fake Currency Code/Fake Currency/Dataest/test_set/1'    #path of folder of images    
path2 = 'E:/Kirti Work/Fake Currency Detection/Fake Currency Code/Fake Currency/Dataest/test/1'  #path of folder to save images    
...
im1 = array(Image.open('/Dataset' + imlist[0])) # open one image to get size
